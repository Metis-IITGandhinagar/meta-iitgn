...
export default function BlogDetailClient({ blog: initialBlog, slug }: BlogDetailClientProps) {
  ...
  const { data, isLoading, error: queryError } = useQuery({
    ...
    initialData: { success: true, blog: initialBlog },
    enabled: !!slug,
  });

  const blog = data?.success ? data.blog : null;
  const loading = isLoading && !blog;
