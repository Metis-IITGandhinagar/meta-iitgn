        ...
        <div className="max-w-2xl mx-auto space-y-4">
          {editors.length === 0 ? (
            <div className="text-center py-20 border border-dashed border-gray-300 bg-white rounded-2xl">
              <p className="text-base-content/60 font-medium">No registered editors found.</p>
            </div>
          ) : (
            editors.map((editor) => {
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-base-200 border border-base-300 flex items-center justify-center font-bold text-base-content/80 shrink-0">
                    {initials}
                  </div>
